...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4d92e73f48f70d600e72fdd709065917) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "xen-api-datamodel";
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "xen_api_datamodel";
                   ...
                   {exec_custom = true; exec_main_is = "datamodel_main.ml"; });
               Executable
                 ({
                     cs_name = "ocaml";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "gen_api_main.ml"; })
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "WM\228\001h\185__\236\164\225\135\149t\136\022";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
